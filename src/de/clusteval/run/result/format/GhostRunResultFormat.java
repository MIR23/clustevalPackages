 ...
 * 
 */
public class GhostRunResultFormat extends RunResultFormat {
	 ...
	 */
	public GhostRunResultFormat(Repository repo, boolean register,
	 ...
	 * @throws RegisterException
	 */
	public GhostRunResultFormat(GhostRunResultFormat other)
			throws RegisterException {
		super(other);
	}
