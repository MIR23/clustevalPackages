 ...
 * 
 */
public class NetalRunResultFormatParser extends RunResultFormatParser {
	 ...
	 * @throws IOException
	 */
	public NetalRunResultFormatParser(final Map<String, String> internalParams,
			final Map<String, String> params, final String absFilePath,
			final DataConfig dataConfig) throws IOException {
		super(internalParams, params, absFilePath, dataConfig, absFilePath
				.replace(".alignment", ".conv"));
		this.skipEmptyLines();
		this.inSplit = " ";
		this.countLines();
	}
