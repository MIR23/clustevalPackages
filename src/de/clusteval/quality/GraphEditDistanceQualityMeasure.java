 ...
 * 
 */
public class GraphEditDistanceQualityMeasure extends QualityMeasure {
	 ...
	 */
	public GraphEditDistanceQualityMeasure(Repository repo, boolean register,
	 ...
	 * @throws RegisterException
	 */
	public GraphEditDistanceQualityMeasure(GraphEditDistanceQualityMeasure other)
			throws RegisterException {
		super(other);
	}
	...
	public QualityMeasureValue getQualityOf(GraphMatching matching,
		...
		return QualityMeasureValue.getForDouble(g1.getEdgeCount()
				+ g2.getEdgeCount() - 2 * ae);
	}
