 ...
 * 
 */
public class AlignedEdgesQualityMeasure extends QualityMeasure {
	 ...
	 */
	public AlignedEdgesQualityMeasure(Repository repo, boolean register,
	 ...
	 * @throws RegisterException
	 */
	public AlignedEdgesQualityMeasure(AlignedEdgesQualityMeasure other)
			throws RegisterException {
		super(other);
	}
	...
	public QualityMeasureValue getQualityOf(GraphMatching matching,
		...
		return QualityMeasureValue.getForDouble(ae);
	}
