 ...
 * 
 */
public class LTwoCompactnessQualityMeasure extends QualityMeasure {
	 ...
	 */
	public LTwoCompactnessQualityMeasure(Repository repo, boolean register,
	 ...
	 * @throws RegisterException
	 */
	public LTwoCompactnessQualityMeasure(LTwoCompactnessQualityMeasure other)
			throws RegisterException {
		super(other);
	}
	...
	public QualityMeasureValue getQualityOf(GraphMatching matching,
		...
		return QualityMeasureValue.getForDouble(cg.getCompactness(2));
	}
