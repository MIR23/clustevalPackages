 ...
 * 
 */
public class C_1QualityMeasure extends QualityMeasure {
	 ...
	 */
	public C_1QualityMeasure(Repository repo, boolean register,
	 ...
	 * @throws RegisterException
	 */
	public C_1QualityMeasure(C_1QualityMeasure other)
			throws RegisterException {
		super(other);
	}
	...
	public QualityMeasureValue getQualityOf(GraphMatching matching,
		...
		return QualityMeasureValue.getForDouble(cg.getAmountOfEdgesInLCC());
	}
