 ...
 * 
 */
public class GraphMatchingContext extends Context {
	 ...
	 */
	public GraphMatchingContext(Repository repository, boolean register,
	 ...
	 * @throws RegisterException
	 */
	public GraphMatchingContext(final GraphMatchingContext other)
			throws RegisterException {
		super(other);
	}
	...
	public RunResultFormat getStandardOutputFormat() {
		try {
			...
			return RunResultFormat.parseFromString(repository,
					"TabSepGraphMatchingRunResultFormat");
