...
public class GMLDataSetFormat extends DataSetFormat implements Parsable {
	 ...
	 * 
	 */
	public GMLDataSetFormat(final Repository repo, final boolean register,
	 ...
	 * @throws RegisterException
	 */
	public GMLDataSetFormat(final GMLDataSetFormat other)
			throws RegisterException {
		super(other);
	}
	...
	public DataSetFormatParser getDataSetFormatParser() {
		return new GMLDataSetFormatParser();
	}
