...
public class NodeSignatureDataSetFormat extends DataSetFormat {
	 ...
	 * 
	 */
	public NodeSignatureDataSetFormat(final Repository repo, final boolean register,
	 ...
	 * @throws RegisterException
	 */
	public NodeSignatureDataSetFormat(final NodeSignatureDataSetFormat other)
			throws RegisterException {
		super(other);
	}
	...
	public DataSetFormatParser getDataSetFormatParser() {
		return new NodeSignatureDataSetFormatParser();
	}
