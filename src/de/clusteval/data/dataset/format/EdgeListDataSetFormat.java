...
public class EdgeListDataSetFormat extends DataSetFormat implements Parsable {
	 ...
	 * 
	 */
	public EdgeListDataSetFormat(final Repository repo, final boolean register,
	 ...
	 * @throws RegisterException
	 */
	public EdgeListDataSetFormat(final EdgeListDataSetFormat other)
			throws RegisterException {
		super(other);
	}
	...
	public DataSetFormatParser getDataSetFormatParser() {
		return new EdgeListDataSetFormatParser();
	}
