...
public class PINDataSetFormat extends DataSetFormat {
	 ...
	 * 
	 */
	public PINDataSetFormat(final Repository repo, final boolean register,
	 ...
	 * @throws RegisterException
	 */
	public PINDataSetFormat(final PINDataSetFormat other)
			throws RegisterException {
		super(other);
	}
	...
	public DataSetFormatParser getDataSetFormatParser() {
		return new PINDataSetFormatParser();
	}
