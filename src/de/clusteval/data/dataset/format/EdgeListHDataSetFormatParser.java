...
public class EdgeListHDataSetFormatParser extends DataSetFormatParser {

	@ParserConversions(conversions = {@StringMapping(key = "EdgeListHDataSetFormat", value = "GMLDataSetFormat")})
	public DataSet convertEdgeHToGML(DataSet dataSet,
	...
	@ParserConversions(conversions = {@StringMapping(key = "EdgeListHDataSetFormat", value = "PINDataSetFormat")})
	public DataSet convertEdgeHToPIN(DataSet dataSet,
			DataSetFormat targetFormat) throws IOException,
			InvalidDataSetFormatVersionException, RegisterException,
			UnknownDataSetFormatException, RNotAvailableException {
		return null;
