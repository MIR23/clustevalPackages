...
public class SeqSimDataSetFormat extends DataSetFormat {
	 ...
	 * 
	 */
	public SeqSimDataSetFormat(final Repository repo, final boolean register,
	 ...
	 * @throws RegisterException
	 */
	public SeqSimDataSetFormat(final SeqSimDataSetFormat other)
			throws RegisterException {
		super(other);
	}
	...
	public DataSetFormatParser getDataSetFormatParser() {
		return new SeqSimDataSetFormatParser();
	}
