...
public class GwLEDADataSetFormat extends DataSetFormat implements Parsable {
	 ...
	 * 
	 */
	public GwLEDADataSetFormat(final Repository repo, final boolean register,
	 ...
	 * @throws RegisterException
	 */
	public GwLEDADataSetFormat(final GwLEDADataSetFormat other)
			throws RegisterException {
		super(other);
	}
	...
	public DataSetFormatParser getDataSetFormatParser() {
		return new GwLEDADataSetFormatParser();
	}
