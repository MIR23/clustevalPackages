...
public class PDataSetFormat extends DataSetFormat {
	 ...
	 * 
	 */
	public PDataSetFormat(final Repository repo, final boolean register,
	 ...
	 * @throws RegisterException
	 */
	public PDataSetFormat(final PDataSetFormat other) throws RegisterException {
		super(other);
	}
	...
	public DataSetFormatParser getDataSetFormatParser() {
		return new PDataSetFormatParser();
	}
